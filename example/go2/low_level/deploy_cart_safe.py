...
def _build_parser():
    ...
    parser.add_argument(
        "--checkpoint",default="hopscotch_utils/v2sft3_8000.pt", required=False,
        help="cartwheel kinematic checkpoint; meta.json is discovered beside it",
    )
    parser.add_argument("--meta", default="hopscotch_utils/v2sft3_meta.json", help="override sibling meta.json")
    parser.add_argument(
