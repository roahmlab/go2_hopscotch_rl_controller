...
if __name__ == '__main__':
    ...
    ap.add_argument("--checkpoint", default="hopscotch_utils/afree_999.pt")
    ap.add_argument("--meta", default="hopscotch_utils/afree_meta.json", help="default: meta.json beside the checkpoint")
